...
import { TableMobileCombustion } from '../../components/Table';
...
const ReportMobileCombustion = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axiosPrivate.get(
          'record/read-records/scope/1/category/mobileCombustion',
          {
  ...
  function unitOption() {
    const options = ['Kilometres', 'Litres'];
...
export default ReportMobileCombustion;
