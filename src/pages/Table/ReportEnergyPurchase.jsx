...
import { TableEnergyPurchase } from '../../components/Table';
...
const ReportEnergyPurchase = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axiosPrivate.get(
          'record/read-records/scope/2/category/energyPurchase',
          {
  ...
  function sourceOption() {
    ...
    const electric = ['Electric Grid', 'Electric Generator'];
  ...
  function unitOption() {
    ...
    const electricEnergy = ['kWh', 'GigaJoule', 'toe', 'tce'];

    if (editableData.type.includes('Fuels')) {
      return fuels;
    } else if (editableData.type.includes('Bio')) {
      return bioenergy;
    } else {
...
export default ReportEnergyPurchase;
