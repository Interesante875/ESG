...
export default function CompanyInfo2() {
    ...
    <div className='lg:px-60 md:px-12 pt-7 flex flex-col justify-center items-center gap-6 overflow-y-auto overflow-x-hidden'>
      ...
      <div className="text-zinc-800 text-4xl font-bold font-['Inter'] leading-snug">Certifications & Data</div>
      <div className="text-zinc-800 text-xl font-normal font-['Inter']">Please fill in your company details</div>
      <form className="w-10/12">
      <div className="mb-10">
        <p className = "block mb-6 text-lg font-extrabold font-['Inter'] text-white-900 dark:text-white">SSM Certificate<span className="text-red-600"> *</span></p>
        <label for="cert" className="flex flex-col items-center justify-center w-full h-28 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
        <div class="flex flex-col items-center justify-center pt-5 pb-6">
            <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
            </svg>
            <p class="font-['Inter'] mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload</span> or drag and drop</p>
        </div>
      ...
      <div className="flex font-['Inter'] grid grid-cols-3 gap-1 mb-12">
        ...
        <button className=" text-white text-sm font-semibold font-['Inter'] h-12 px-10 py-2.5 bg-teal-600 hover:bg-teal-800 focus:ring-2 focus:outline-none focus:ring-teal-500 rounded-md dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800">Next</button>
        </div>
      </div>
    </form>
  </div>
