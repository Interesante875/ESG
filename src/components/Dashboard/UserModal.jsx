...
//   return (
//     <div
//       className="fixed inset-0 bg-black flex justify-center items-center p-4 z-1000"
//       onClick={onClose}
//     >
//       <div
//         ref={modalRef}
//         className="mx-auto border bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 z-100 relative max-w-lg w-full max-h-[50vh] overflow-auto"
//         onClick={(e) => e.stopPropagation()}
//       >
//         <div className="flex flex-col justify-between items-center">
//           <h4 className="text-xl font-bold text-black dark:text-gray-50 flex p-2 rounded">
...
//         </NavLink>
//         <button className="text-lg text-gray-700 dark:text-gray-300 mb-4 flex w-full text-left p-2 hover:bg-gray-500 rounded">
